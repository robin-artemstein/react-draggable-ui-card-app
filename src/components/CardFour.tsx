...
export const CardFour: React.FC<CardProps> = ({ id }) => {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="flex-grow sm:flex-grow-0 w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.33%-16px)] min-w-[300px] p-6 bg-zinc-50 dark:bg-zinc-900 border-1 border-zinc-400 dark:border-zinc-600 rounded-xl shadow-lg shadow-zinc-00 dark:shadow-zinc-700 transition-colors duration-300"
    >
      <div
        {...attributes}
        {...listeners}
      ...
      >
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-white select-none">Quarterly Projections</h3>
      </div>
