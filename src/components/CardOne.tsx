...
export const CardOne: React.FC<CardProps> = ({ id }) => {
  ...
  return (
    ...
    >
      {/* 2-Column Grid Header acting as the dedicated Drag Handle */}
      <div
        {...attributes}
        {...listeners}  
        className="grid grid-cols-[auto_1fr] gap-3 items-center cursor-grab active:cursor-grabbing mb-4 p-1 hover:bg-gray-50 dark:hover:bg-gray-750 rounded-xl transition-colors"
      >
        ...
        <h3 className="text-lg font-bold text-gray-900 dark:text-white select-none">Gross Revenue</h3>
      </div>
